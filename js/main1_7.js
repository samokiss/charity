...
jQuery(document).ready(function ($) {
    ...
    var siteCarousel = function () {
        if ($('.nonloop-block-13').length > 0) {
            $('.nonloop-block-13').owlCarousel({
                                                   ...
                                                   responsive: {
                                                       600: {
                                                           margin: 0, nav: true, items: 2
                                                       }, 1000: {
                                                           margin: 0, stagePadding: 0, nav: true, items: 2
                                                       }, 1200: {
                                                           margin: 0, stagePadding: 0, nav: true, items: 3
                                                       }
                                                   }
                                               });
        }
    ...
    var cleanPage = function () {
        ...
        $("p:contains(Ensemble Bâtissons)").remove();
        $("html").css("font-size", "100%");
        $("html").fadeOut();
        $("html").removeClass("hidden").fadeIn("slow");
